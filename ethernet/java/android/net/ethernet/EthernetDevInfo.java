...
/**
 * Describes the state of any Ethernet connection that is active or is in the
...
public class EthernetDevInfo implements Parcelable {
	 ...
	 *
	 * @param mode
	 *            {@code ETHERNET_CONN_MODE_DHCP} for dhcp
	 *            {@code ETHERNET_CONN_MODE_MANUAL} for manual configure
	 * @return
	 */
